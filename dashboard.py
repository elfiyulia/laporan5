...
# HEADER UI
# =====================
st.markdown("<div class='header-box'><h1>Klasifikasi Gambar dan Deteksi Objek</h1><h5>Kendaraan & Jajanan Tradisional</h5></div>", unsafe_allow_html=True)
...
# FOOTER
# =====================
st.markdown("<footer>📌 Dashboard — oleh Elfi</footer>", unsafe_allow_html=True)
